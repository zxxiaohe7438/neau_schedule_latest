 ...
 * 零依赖、随 currentColor 主题变色；结构用途图标禁止用 emoji（ui-ux-pro-max 规则）。
 */
interface IconProps {
  size?: number;
}
...
export function MapPinIcon({ size = 12 }: IconProps) {
  return (
    <svg {...baseProps(size)}>
...
export function SquareIcon({ size = 12 }: IconProps) {
  return (
    <svg {...baseProps(size)}>
...
export function RestoreIcon({ size = 12 }: IconProps) {
  return (
    <svg {...baseProps(size)}>
